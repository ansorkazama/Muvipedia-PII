...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int movie_id_column = mCursor.getColumnIndex(MuviContract.MoviePopular.CL_MOVIE_ID);
...
//                + mCursor.getString(PopularMovieFragment.CL_POPULAR_INDEX) + " "
//                + mCursor.getString(PopularMovieFragment.CL_TITLE);
//        movieViewHolder.mDebuggingTextView.setText(debugging_text);

        String vote = mCursor.getString(PopularMovieFragment.CL_VOTE_AVERAGE);
        String movie_title = mCursor.getString(PopularMovieFragment.CL_TITLE);
        ...
        String movie_poster_path = mCursor.getString(PopularMovieFragment.CL_POSTER_PATH);
...
//                .into(movieViewHolder.mPosterView);
        ...
        int movie_id = mCursor.getInt(PopularMovieFragment.CL_MOVIE_ID);
        movieViewHolder.mListItem.setBackgroundColor(
                mContext.getResources().getColor(R.color.white));

        String table_name = mCursor.getString(PopularMovieFragment.CL_THIS_TABLE_NAME);
        if (table_name.contains("favorites")) {
            int favorite_flag = mCursor.getInt(PopularMovieFragment.CL_FAVORITE);
            if (favorite_flag == 1) {
...
//                    }
            ...
            int favorite_flag = mCursor.getInt(PopularMovieFragment.CL_FAVORITE);
            if (favorite_flag == 1 || mTM.cheFavoriteID(movie_id)) {
                movieViewHolder.mHeartFlagView.setVisibility(View.VISIBLE);
                movieViewHolder.mHeartFlagView.setContentDescription("The movie is a favorite");
            } else {
                movieViewHolder.mHeartFlagView.setVisibility(View.INVISIBLE);
