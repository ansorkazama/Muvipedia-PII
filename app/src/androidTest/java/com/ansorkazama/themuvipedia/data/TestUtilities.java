...
import com.ansorkazama.themuvipedia.utils.PollingCheck;
...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createMovieValues() {
        ...
        movieValues.put(MoviePopular.CL_MOVIE_ID, 1234);
        movieValues.put(MoviePopular.CL_POPULAR_INDEX, 1);
        movieValues.put(MoviePopular.CL_TOP_RATED_INDEX, 1);
...
//        MuviDbHelper dbHelper = new MuviDbHelper(context);
